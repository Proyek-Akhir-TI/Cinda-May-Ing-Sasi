    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <div class="row d-flex d-inline">
                <div class="col">
                    <h6 class="font-weight-bold text-primary mb-0">Transaksi</h6>
                </div>
                <div class="col text-right">
                    <a href="{{route('admin.transaksi.create')}}" class="font-weight-bold text-primary mb-0"><i class="fas fa-plus"></i></a>
                </div>
            </div>
        </div>
        <div class="card-body">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="text-warning" href="{{route('admin.transaksi.edit', $tran->id)}}"><i class="fas fa-edit"></i></a>
                                <a class="text-danger" href="#" data-toggle="modal" data-target="#delete" data-id="{{ $tran->id }}" ><i class="fas fa-trash"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
        ...
        {{-- <div class="modal-content">
            <form action="{{ route('admin.tipe_kendaraan.store') }}" method="POST">
                ...
                <div class="modal-header">
                    <h5 class="modal-title"><span>Tambah</span> Transaksi</h5>
...
<div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            {{-- lain kali jangan lupa diganti ya route a bahaya loh kalo lupa, tadi pas testing udah berkali2 kok gk mau ternyaata salah route disini --}}
            <form action="{{ route('admin.transaksi.delete') }}" method="POST">
                @csrf
                @method('DELETE')
                ...
                <div class="modal-body">
                    Apakah Anda yakin ingin menghapus data transaksi ini? <br>
