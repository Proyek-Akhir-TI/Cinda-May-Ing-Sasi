...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('admin.transaksi.update', ['id' => $transaksi->id]) }}" method="post">
                @csrf
                @method('PUT')
                {{-- <input type="hidden" name="id" value="{{$transaksi->id}}"> --}}
                <div class="form-group">
                    <label for="pelanggan_id">Nama Pelanggan</label>
                    <input type="text" class="form-control @error('pelanggan_id') is-invalid @enderror" id="pelanggan_id" name="pelanggan_id" value="{{ $transaksi->pelanggan->nama }}" disabled>
                    @error('pelanggan_id')
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" class="form-control @error('alamat') is-invalid @enderror" id="alamat" readonly name="alamat" required>{{$transaksi->alamat}}</textarea>
                    @error('alamat')
                    <div class="invalid-feedback">
                        {{$message}}
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('no_telp') is-invalid @enderror" id="no_telp" readonly name="no_telp" value="{{$transaksi->no_telp}}" required>
                    @error('no_telp')
                    <div class="invalid-feedback">
                        {{$message}}
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('tipe') is-invalid @enderror" id="tipe" name="tipe" value="{{ $transaksi->tipe }}" required>
                    @error('tipe')
                    <div class="invalid-feedback">
                        {{$message}}
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('plat') is-invalid @enderror" id="plat" name="plat" value="{{ $transaksi->plat }}" required>
                    @error('plat')
                    <div class="invalid-feedback">
                        {{$message}}
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input type="datetime-local" class="form-control @error('waktu') is-invalid @enderror" id="waktu" name="waktu" value="{{ date('Y-m-d\TH:i', strtotime($transaksi->waktu)) }}" required>
                    @error('waktu')
                    <div class="invalid-feedback">
                        {{$message}}
                    </div>
                ...
                <div class="form-group">
                    <label for="alasan">Alasan <small>* Wajib diisi jika status transaksi di cancel</small></label>
